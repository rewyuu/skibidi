...
<body id="top">
        ...
        <div class="container">
          ...
          <nav class="navbar" data-navbar>
            <ul class="navbar-list">
              ...
              <li class="nav-item">
                <a href="javascript:void(0)" onclick="redirectToSignUp()" class="navbar-link" data-nav-link>Order Now</a>
              </li>
          ...
          <div class="header-btn-group">
            <button class="btn btn-hover" onclick="redirectToSignUp()">Sign Up</button>
            <script>
              function redirectToSignUp() {
                  window.location.href = "register-login/registration.php";
              }
          </script>

            <button class="btn btn-hover" onclick="redirectToLogin()">Log in</button>
            <script>
    ...
    <main> 
        <article>
            ...
            <section class="hero" id="home" style="background-image: url('images/hero-bg.jpg')">
                <div class="container">
                  ...
                  <div class="hero-content">
                    ...
                    <button class="btn" onclick="redirectToSignUp()">Order Now</button>
          ...
          <script> // send it here directly cuz it doesnt work on an external js file -_-
                ...
                <li>
                    <div class="food-menu-card" data-category="<?php echo htmlspecialchars($product['category']); ?>">
                        ...
                        alt="<?php echo htmlspecialchars($product['name']); ?>" class="w-100">
                            <button class="btn food-menu-btn" onclick="redirectToSignUp()">Order Now</button>
                        </div>
                        <div class="wrapper">
